import { passThroughInterceptor, setHeader, AUTHORIZATION_HEADER, HttpClient, createRequestBuilderFactory, ApiError } from '@apimatic/core';
...
import { object, string, number, optional, unknown, lazy } from '@apimatic/schema';
 ...
 *
 */
var checkoutPayloadSchema = /*#__PURE__*/object({
  invoice_id: ['invoice_id', /*#__PURE__*/string()],
  payment_processor_id: ['payment_processor_id', /*#__PURE__*/string()],
  customer_msisdn: ['customer_msisdn', /*#__PURE__*/string()],
  otp: ['otp', /*#__PURE__*/string()]
});
...
var customerSchema = /*#__PURE__*/object({
  ...
  country: ['country', /*#__PURE__*/number()],
  city: ['city', /*#__PURE__*/number()],
  details: ['details', /*#__PURE__*/optional( /*#__PURE__*/unknown())]
});
...
var typeSchema = /*#__PURE__*/string();
var invoiceSchema = /*#__PURE__*/object({
  customer: ['customer', /*#__PURE__*/lazy(function () {
    return customerSchema;
  })],
  type: ['type', /*#__PURE__*/lazy(function () {
    return typeSchema;
  })],
  amount: ['amount', /*#__PURE__*/number()],
  reference_id: ['reference_id', /*#__PURE__*/string()],
  token: ['token', /*#__PURE__*/string()]
});
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              mapped = req.prepareArgs({
                clientId: [(_credentials$clientId = credentials == null ? void 0 : credentials.clientId) != null ? _credentials$clientId : this.credentials.clientId, string()],
                clientSecret: [(_credentials$clientSe = credentials == null ? void 0 : credentials.clientSecret) != null ? _credentials$clientSe : this.credentials.clientSecret, string()]
              });
              ...
              return _context.abrupt("return", req.callAsJson(unknown(), requestOptions).then(function (res) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              mapped = req.prepareArgs({
                invoicePayload: [invoicePayload, lazy(function () {
              ...
              */
              ...
              return _context2.abrupt("return", req.callAsJson(unknown(), requestOptions).then(function (res) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              mapped = req.prepareArgs({
                checkoutPayload: [checkoutPayload, lazy(function () {
              ...
              return _context4.abrupt("return", req.callAsJson(unknown(), requestOptions).then(function (res) {
                return JSON.parse(res.body);
              }));
...
export { ApiController, Client, DEFAULT_CONFIGURATION, DEFAULT_RETRY_CONFIG, Environment };
//# sourceMappingURL=sappaylib.esm.js.map
